function varargout = ultimatum_selection30(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ultimatum_selection30_OpeningFcn, ...
                   'gui_OutputFcn',  @ultimatum_selection30_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ultimatum_selection30 is made visible.
function ultimatum_selection30_OpeningFcn(hObject, eventdata, handles, varargin)
...
save('ultimatum_selection30','data')
close('ultimatum_selection30')
...
function varargout = ultimatum_selection30_OutputFcn(hObject, eventdata, handles) 
