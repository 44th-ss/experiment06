function varargout = dictator_selection4(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dictator_selection4_OpeningFcn, ...
                   'gui_OutputFcn',  @dictator_selection4_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before dictator_selection4 is made visible.
function dictator_selection4_OpeningFcn(hObject, eventdata, handles, varargin)
...
% UIWAIT makes dictator_selection4 wait for user response (see UIRESUME)
...
save('dictator_selection4','data')
close('dictator_selection4')
end
...
function varargout = dictator_selection4_OutputFcn(hObject, eventdata, handles) 
